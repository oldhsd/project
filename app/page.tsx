...
import { initialTracks, initialOpportunities, initialEvents } from '@/lib/data-service';
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#f5f5f7] selection:bg-[#0071e3] selection:text-white">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/[0.08] bg-[#000000]/70 backdrop-blur-2xl px-6 py-3.5 flex items-center justify-between">
        ...
        {/* Student Navigation (NO ADMIN LINKS) */}
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/signup"
            className="apple-btn-primary h-8 px-4 rounded-full text-xs font-semibold"
          >
            Get Started
          </Link>
        </div>
      ...
      <section className="pt-32 pb-20 px-6 max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3.5">
          <Link
            href="/dashboard"
            className="apple-btn-primary h-11 px-6 rounded-full text-sm font-semibold flex items-center gap-2 shadow-lg shadow-[#0071e3]/20"
          >
          ...
          <Link
            href="/tracks"
            className="apple-btn-secondary h-11 px-6 rounded-full text-sm font-medium border border-white/[0.15] bg-white/[0.06] hover:bg-white/[0.1] text-white"
          >
      ...
      <section className="py-20 px-6 border-t border-white/[0.08] max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="mt-2 text-3xl sm:text-4xl font-bold tracking-tight text-white">
            Designed for what you want to build.
          </h2>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {initialTracks.slice(0, 6).map((t) => (
            <div
              key={t.id}
              className="rounded-2xl border border-white/[0.08] bg-[#0d0d11] p-6 hover:border-[#2997ff]/40 transition duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-[#6e6e73]">{t.difficulty}</span>
                </div>
                <h3 className="mt-4 text-base font-semibold text-white tracking-tight">{t.name}</h3>
                <p className="mt-2 text-xs text-[#86868b] leading-relaxed line-clamp-3">{t.description}</p>
              </div>

              <div className="mt-6 pt-4 border-t border-white/[0.06] flex items-center justify-between text-xs">
                <span className="text-[#6e6e73]">{t.estimatedHours} hrs · {t.modulesCount} modules</span>
                <Link href={`/tracks/${t.id}`} className="text-[#2997ff] font-medium hover:underline flex items-center gap-1">
      ...
      {/* Partner Network: GFG, Unstop, Elite Globex */}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-12">
            ...
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-white">
              Official Partners & Direct Hiring Pathways
            </h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[#121218] p-6">
              ...
              <p className="mt-3 text-xs text-[#86868b]">
                National coding clash with 400+ participants, co-branded participation certificates, and problem-setter fellowships.
              </p>
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[#121218] p-6">
              ...
              <p className="mt-3 text-xs text-[#86868b]">
                Direct pipeline into full stack and applied AI research roles with stipends up to ₹30,000/month.
              </p>
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[#121218] p-6">
              ...
              <p className="mt-3 text-xs text-[#86868b]">
                48-hour innovation challenges with ₹1,50,000 prize pools, mentor reviews, and verified profile credentials.
              </p>
      ...
      <section className="py-20 px-6 border-t border-white/[0.08] text-center max-w-3xl mx-auto">
        ...
        <h2 className="text-3xl font-bold tracking-tight text-white">
          Every achievement is publicly verifiable.
        </h2>
        <p className="mt-3 text-xs sm:text-sm text-[#86868b]">
        ...
        <div className="mt-8 flex justify-center gap-3">
          <Link
            href="/verify"
            className="apple-btn-secondary h-10 px-5 rounded-full text-xs font-medium border border-white/[0.15] bg-white/[0.05] text-white hover:bg-white/[0.1]"
          >
