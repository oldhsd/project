export default function Projects(){return <><header><p className="text-sm font-medium text-[#0071e3]">BUILD IN PUBLIC</p><h1 className="mt-2 text-3xl font-bold">Projects that prove the work.</h1><p className="muted mt-2">Choose a challenge, submit your repository, and grow your portfolio.</p></header><div className="mt-8 grid gap-4 md:grid-cols-2"><article className="panel p-6"><span className="text-sm text-[#0071e3]">BEGINNER</span><h2 className="mt-3 text-xl font-bold">Personal Portfolio</h2><p className="muted mt-3">Design and ship a thoughtful home for your work.</p><button className="btn btn-primary mt-6">View challenge</button></article><article className="panel p-6"><span className="text-sm text-[#0071e3]">INTERMEDIATE</span><h2 className="mt-3 text-xl font-bold">Community Dashboard</h2><p className="muted mt-3">Turn a real data set into a calm, useful interface.</p><button className="btn btn-primary mt-6">View challenge</button></article></div></>}
'use client';
